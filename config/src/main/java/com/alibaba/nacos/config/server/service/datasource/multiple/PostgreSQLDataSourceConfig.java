...
import com.alibaba.nacos.config.server.service.repository.extrnal.repositorys.postgresql.PostgreSQLConfigInfoRepository;
...
import com.alibaba.nacos.config.server.service.repository.extrnal.dialect.postgresql.PostgreSQLPageHelper;
import com.alibaba.nacos.config.server.service.repository.extrnal.repositorys.postgresql.PostgreSQLHisConfigInfoRepository;
import org.springframework.boot.autoconfigure.condition.ConditionalOnExpression;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

@ConditionalOnExpression("'${spring.datasource.platform}'.equalsIgnoreCase('postgresql')")
@Configuration
public class PostgreSQLDataSourceConfig {
    ...
    public ConfigInfoRepository registerConfigInfoRepository() {
        return new PostgreSQLConfigInfoRepository();
    }
    ...
    public HisConfigInfoRepository registerHisConfigInfoRepository() {
        return new PostgreSQLHisConfigInfoRepository();
    }
    ...
    public DialectPageHelper registerDialectPageHelper() {
        return new PostgreSQLPageHelper();
    }
}
