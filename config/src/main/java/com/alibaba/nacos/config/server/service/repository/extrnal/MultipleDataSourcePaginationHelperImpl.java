...
public class MultipleDataSourcePaginationHelperImpl<E> implements PaginationHelper {
    
    private final JdbcTemplate jdbcTemplate;
    
    private final DialectPageHelper dialectPageHelper;
    
    public MultipleDataSourcePaginationHelperImpl(JdbcTemplate jdbcTemplate, DialectPageHelper dialectPageHelper) {
        this.jdbcTemplate = jdbcTemplate;
        this.dialectPageHelper = dialectPageHelper;
    }
    ...
    public Page<E> fetchPage(final String sqlCountRows, final String sqlFetchRows, final Object[] args,
        ...
        if (lastMaxId != null) {
            selectSql = selectSql + " and id > " + lastMaxId + " order by id asc";
        }
        selectSql = dialectPageHelper.buildLimitSql(selectSql, pageNo, pageSize);
    ...
    public Page<E> fetchPageLimit(final String sqlCountRows, final Object[] args1, final String sqlFetchRows,
        ...
        String selectSql = dialectPageHelper.replaceLimitSql(sqlFetchRows, pageNo, pageSize);
